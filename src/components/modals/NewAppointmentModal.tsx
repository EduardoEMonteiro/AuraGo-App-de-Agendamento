...
export const NewAppointmentModal: React.FC<Props> = ({ isVisible, onClose, onSave, clients, services, selectedDate }) => {
  ...
  const handleSave = () => {
    ...
    const appointmentData = {
      ...
      date: dateString,
      notes,
      servicoValor: selectedService.valor, // Salva o valor do serviço
    };
    ...
    <Modal visible={isVisible} onRequestClose={onClose} animationType="slide">
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          <TouchableOpacity onPress={onClose} style={styles.closeButton}><Feather name="x" size={24} color={Colors.textPrimary} /></TouchableOpacity>
